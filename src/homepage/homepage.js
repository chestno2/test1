...
const Homepage = () => {
  ...
  function toggle() {
    ...
    document.querySelector(".tezos").classList.toggle("border-top");
    document.querySelector(".ethereum").classList.toggle("border-top");
  }
    ...
    <div className="homepage">
      <Container>
        ...
        <Box className="homepageBox">
          <div className="boxImagesDiv tezos" onClick={handleShow1}>
          ...
          <div
            className="boxImagesDiv border-top ethereum"
            onClick={handleShow2}
          >
